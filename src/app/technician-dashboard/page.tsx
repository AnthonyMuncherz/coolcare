...
export const metadata: Metadata = {
  title: 'Technician Dashboard - CoolCare',
...
export async function TechnicianDashboardPage() {
  // Check if user is authenticated and is a technician
  const user = await requireAuth();
  
  // If user is not a technician, redirect to dashboard
          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex space-x-3">
                <Link 
                  href="/technician-dashboard/maintenance"
            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
              <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                ...
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                  Pending and in-progress requests that require your attention
                </p>
              </div>
                      ...
                      {serviceRequests.map((request) => (
                        <tr key={request.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <Link 
                              href={`/technician-dashboard/service-request/${request.id}`}
                              className="text-blue-600 hover:text-blue-900 mr-4"
                            >
                              View
                            </Link>
                            <Link 
                              href={`/technician-dashboard/service-request/${request.id}/update`}
